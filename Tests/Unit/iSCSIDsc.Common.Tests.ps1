# Import the iSCSIDsc.Common module to test
$script:resourceModulePath = Split-Path -Path (Split-Path -Path $PSScriptRoot -Parent) -Parent
$script:modulesFolderPath = Join-Path -Path $script:resourceModulePath -ChildPath 'Modules\iSCSIDsc.Common'

Import-Module -Name (Join-Path -Path $script:modulesFolderPath -ChildPath 'iSCSIDsc.Common.psm1') -Force

InModuleScope 'iSCSIDsc.Common' {
    Describe 'iSCSIDsc.Common\Test-DscParameterState' -Tag TestDscParameterState {
    ...
    Describe 'iSCSIDsc.Common\Get-LocalizedData' {
        $mockTestPath = {
    ...
    Describe 'iSCSIDsc.Common\New-InvalidResultException' {
    ...
    Describe 'iSCSIDsc.Common\New-ObjectNotFoundException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'iSCSIDsc.Common\New-InvalidOperationException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'iSCSIDsc.Common\New-NotImplementedException' {
    ...
    Describe 'iSCSIDsc.Common\New-InvalidArgumentException' {
