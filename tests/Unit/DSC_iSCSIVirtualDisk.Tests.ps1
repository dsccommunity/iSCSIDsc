...
try
{
    InModuleScope $script:dscResourceName {
        ...
        Describe "DSC_iSCSIVirtualDisk\Get-TargetResource" {
        ...
        Describe "DSC_iSCSIVirtualDisk\Set-TargetResource" {
        ...
        Describe "DSC_iSCSIVirtualDisk\Test-TargetResource" {
        ...
        Describe "DSC_iSCSIVirtualDisk\Get-VirtualDisk" {
